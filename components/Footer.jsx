        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 mb-6 max-w-sm">
              Thesis and dissertation success. Using AI.
            </p>
            
            {/* Social Media Icons */}
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Service status</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              ...
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Research guides</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Writing tips</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Defense prep</a></li>
            </ul>
            
            <h3 className="font-bold text-gray-900 mb-4">Community</h3>
            <p className="text-gray-600 text-sm mb-4">
              Join our academic community to learn how to use all of our tools faster and better.
            </p>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © 2025 ThesisMaster. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-gray-500 hover:text-gray-700 text-sm">Legal</a>
              <a href="#" className="text-gray-500 hover:text-gray-700 text-sm">Accessibility</a>
