    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <p className="text-xl text-gray-600 mb-12">
          Start your thesis journey with the perfect plan for your academic goals
        </p>
        ...
        <div className="flex items-center justify-center mb-16">
          ...
          <span className="text-gray-700 ml-3">Annual</span>
          <span className="ml-2 bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded">Save 20%</span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 relative">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Masters</h3>
              <p className="text-gray-600 mb-6">Perfect for masters students</p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 relative border-2 border-blue-500">
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">PhD</h3>
              <p className="text-gray-600 mb-6">Complete PhD support</p>
              ...
              <ul className="space-y-4 mb-8 text-left">
                <li className="flex items-center">
                  ...
                  <span>Everything in Masters</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                ...
                <li className="flex items-center">
                  ...
                  <span>Mock Defense Sessions</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 relative">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">For institutions & departments</p>
        ...
        <div className="mt-24 max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">What's included in the University plan?</h3>
              <p className="text-gray-600">The University plan includes everything from our PhD plan plus institutional features like admin dashboards, bulk management, analytics, and dedicated support.</p>
            </div>
            
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Do you offer student discounts?</h3>
              <p className="text-gray-600">Yes, we offer additional discounts for students with valid .edu email addresses. Contact us for more information.</p>
            </div>
          </div>
        </div>
      </div>
