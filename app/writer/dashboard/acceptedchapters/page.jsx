...
export default function WriterAcceptedChapters() {
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <span className="block text-sm font-medium text-gray-700">Student</span>
                      <span className="text-gray-900">{selectedChapter.user?.name || 'Unknown'}</span>
                    </div>
                    <div>
                      <span className="block text-sm font-medium text-gray-700">Status</span>
                      <span className={`px-2 py-1 rounded-full text-sm font-medium ${getStatusColor(selectedChapter.status)}`}>
                        {selectedChapter.status.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase())}
                      </span>
                    </div>
                    <div>
                      <span className="block text-sm font-medium text-gray-700">Target Words</span>
                      <span className="text-gray-900">{selectedChapter.targetWordCount?.toLocaleString()}</span>
                    </div>
                    <div>
                      <span className="block text-sm font-medium text-gray-700">Current Words</span>
                      <span className="text-gray-900">{selectedChapter.wordCount?.toLocaleString() || 0}</span>
                    </div>
                    <div>
                    ...
                    <div>
                      <span className="block text-sm font-medium text-gray-700">Your Earnings</span>
                      <span className="text-gray-900 font-semibold">{formatCurrency(selectedChapter.earnings || 0)}</span>
                    </div>
                  </div>

                  {selectedChapter.notes && (
                    <div>
                      <span className="block text-sm font-medium text-gray-700 mb-2">Notes</span>
                      <div className="bg-gray-50 p-3 rounded-lg">
                        <p className="text-gray-700">{selectedChapter.notes}</p>
                      </div>
                    </div>
                  )}
